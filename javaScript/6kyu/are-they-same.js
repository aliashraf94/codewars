...
function comp(a, b) {
    // Check if either of the arrays is null or undefined
    if (!a || !b) {
      return false;
    }
    ...
    // Create a copy of array a and square each element
    ...
    // Check if the squared arrays are equal
    return squaredA.every((num, index) => num === b[index]);
  }
